...
export default function NavBar() {
  return (
    <nav className="mb-5 flex h-20 items-center space-x-2 border-b bg-black px-2 text-color-3">
      <Link className="text-4xl hover:text-color-1 md:text-6xl" href="/">
        <GiFoodTruck />
      </Link>
      <ul className="flex items-center space-x-6 pl-4">
        <li>
          <Link className="text-base md:text-xl" href={FOOD_FORM_URL}>
            <span className="flex items-center gap-2 hover:text-color-1">
              New <AiOutlinePlus />
            </span>
          </Link>
        </li>
